defmodule FirestormWeb.OembedExtractorTest do
  use ExUnit.Case
  ...
  test "returns a list of oembed data for a given block of text, by extracting links" do
    ...
    empire_city_elixir_conf_vid =
      %OEmbed.Video{author_name: "Empire City Elixir Conference",
        ...
        html: "<iframe width=\"480\" height=\"270\" src=\"https://www.youtube.com/embed/H686MDn4Lo8?feature=oembed\" frameborder=\"0\" gesture=\"media\" allowfullscreen></iframe>",
