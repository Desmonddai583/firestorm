defmodule FirestormWeb.Api.V1.FetchViewTest do
  use FirestormWeb.ConnCase, async: true
  alias FirestormWeb.Api.V1.{FetchView, CategoryView, ThreadView, PostView, UserView}
  alias Firestorm.Store.ReplenishResponse
